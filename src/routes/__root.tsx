...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "RN-led mental health and complex care support for NDIS participants in Adelaide. Person-centred, recovery-focused services including psychosocial support, nursing care, daily living, and community participation." },
      { name: "author", content: "MindBridge Support Services" },
